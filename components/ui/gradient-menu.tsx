    ...
    <ul className="flex gap-2 sm:gap-4 items-center">
      {menuItems.map(({ title, icon: Icon, gradientFrom, gradientTo }, idx) => (
        <li
          ...
          className="relative w-10 h-10 sm:w-[50px] sm:h-[50px] bg-white dark:bg-zinc-900 shadow-md rounded-full flex items-center justify-center transition-all duration-500 hover:w-24 sm:hover:w-[150px] hover:shadow-none group cursor-pointer border border-zinc-200/50 dark:border-zinc-800/50"
        >
